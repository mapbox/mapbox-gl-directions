...
<div class='directions-control directions-control-directions'>
  <div class='mapbox-directions-component mapbox-directions-route-summary ${options.routes > 1 ? 'mapbox-directions-multiple' : ''}
    ${options.routes < 1
      ? ""
      : Array.from(Array(options.routes)).map(i => {
        return `
    ...
    <div class='mapbox-directions-instructions-wrapper'>
      ...
      return `
          <li
            ...
            ${distance
          ? `<div class='mapbox-directions-step-distance'> ${distance} </div>`
          : ''
        }
          </li>
`;
